class PrimalSnake {
  ...
  void testWalls() {
    //log.append("PrimalSnake.testWalls");
    //testWalls
    if (wallteletime > 2) {
  ...
  void testFood() {
    //log.append("PrimalSnake.testFood");
    //TestFood
   ...
   ***************************************/
  void nextTile() {
    //log.append("PrimalSnake.nextTile");
   ...
   ***************************************/
  void updateSnake() {
    //log.append("PrimalSnake.updateSnake");
  ...
  void teleport(float x, float y) {
    //log.append("PrimalSnake.teleport");
    newpos[0] = round(x);
    newpos[1] = round(y);
  }
  ...
  void moveNPC() {
    //log.append("PrimalSnake.moveNPC");
    if (NPC == false)
      return;
  ...
  void moveHumanPlayer() {
    //log.append("PrimalSnake.moveHumanPlayer");
    if (NPC != false)
      return;
    if (isAndroid == true)
      moveOnAndroid();
  ...
  void moveOnAndroid() {
    //log.append("PrimalSnake.moveOnAndroid");
    Angle = AndroidAngle;
  }

  void moveOnPC() {
    //log.append("PrimalSnake.moveOnPC");
