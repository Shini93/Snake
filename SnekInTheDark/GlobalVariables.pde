...
PVector worldSize;
PVector offsetMult = new PVector(0,0);
int sizeFont = 30;
int maxFood = 0;                //maximum food collected
byte actualLevel = 1;                      //defaultlevel
int maximumDesignLvl, maxReachedLvl = 1;
...
Math math = new Math();
Button androidSpeed, androidRocket, androidPause;
...
SoundFile[] gameSound = new SoundFile[3];    //food
SoundFile music;
...
ArrayList<Laterne> laternen = new ArrayList <Laterne>();  //Spawns Food
